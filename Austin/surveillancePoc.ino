/*
* This poc project capture a 3 photos and store it on your google drive.
* Note - You need to configure your google drive and generate the development script.
*/
...
String myDeploymentID = "<Enter your development id here>";
...
void setup() {
  ...
  // Selectable camera resolution details : Treat it as a camera reference
  ...
  Test_Con();
  Serial.println();
  Serial.println("ESP32-CAM captures and sends photos to the server every 30 seconds.");
  Serial.println();
  delay(2000);
}

void loop() {
  // Timer/Millis to capture and send photos to Google Drive every 30 seconds (see Interval variable).
